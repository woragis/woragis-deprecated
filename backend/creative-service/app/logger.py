"""
Structured logging utility for Creative Service.
...
def configure_logging(env: str = "development", log_to_file: bool = False, log_dir: str = "logs"):
    ...
    if not is_production and log_to_file:
        ...
        log_file = os.path.join(log_dir, "creative-service.log")
...
def get_logger(name: str = "woragis.creative-service"):
    """
    ...
    logger = logger.bind(service="creative-service")
