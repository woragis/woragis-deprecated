...
// Error sends an error response using Fiber
func Error(c *fiber.Ctx, statusCode int, code int, message string, data interface{}) error {
	response := Response{
		Success: false,
		Message: message,
		Code:    code,
...
// Success sends a success response using Fiber
