...
type Service interface {
	CreateResume(ctx context.Context, userID uuid.UUID, title, filePath, fileName string, fileSize int64) (*Resume, error)
	UpdateResume(ctx context.Context, userID uuid.UUID, resumeID uuid.UUID, title string) (*Resume, error)
...
func (s *service) CreateResume(ctx context.Context, userID uuid.UUID, title, filePath, fileName string, fileSize int64) (*Resume, error) {
	resume, err := NewResume(userID, title, filePath, fileName, fileSize)
	if err != nil {
		return nil, err
	}
...
func (s *service) UpdateResume(ctx context.Context, userID uuid.UUID, resumeID uuid.UUID, title string) (*Resume, error) {
