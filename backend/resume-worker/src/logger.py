"""
Structured logging utility for Resume Worker.
...
def configure_logging(env: str = "development", log_to_file: bool = False, log_dir: str = "logs"):
    ...
    if not is_production and log_to_file:
        ...
        log_file = os.path.join(log_dir, "resume-worker.log")
...
def get_logger(name: str = "woragis.resume-worker"):
    """
    ...
    logger = logger.bind(service="resume-worker")
