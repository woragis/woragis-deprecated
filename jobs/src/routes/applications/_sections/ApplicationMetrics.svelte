...
<div class="metrics-container">
	<div class="metrics-grid">
		...
		<div class="metric-card">
			<div class="metric-value">{metrics().byStatus.applied}</div>
			<div class="metric-label">Applied</div>
		</div>
		<div class="metric-card">
			<div class="metric-value">{metrics().byStatus.contacted}</div>
			<div class="metric-label">Contacted</div>
		</div>
		<div class="metric-card">
			<div class="metric-value">{metrics().byStatus.accepted}</div>
