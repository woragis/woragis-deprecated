						...
						<tr>
							<td>
								<div class="item-title">
									<a
										href="/landing/technical-writings/{writing.id}"
										class="font-medium hover:text-violet-400 transition-colors"
									>
										{writing.title}
									</a>
									{#if writing.url}
										<a href={writing.url} target="_blank" class="text-muted text-sm">External →</a>
									{/if}
								</div>
							</td>
